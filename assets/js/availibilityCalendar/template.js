...
<form action="/recruiter/interview/available" method="post" class="InterviewRemove">
<input class="eventId" type="hidden" value="${event.id}" name="id">
  <button type="submit"  class="btn avalibility btn-falcon-success btn-sm">
    Available<span class="fas fa-check fs--2 ms-2"></span>
  </button>
  </form>
<form action="/recruiter/interview/notAvailable" method="post" class="InterviewRemove">
<input class="eventId" type="hidden" value="${event.id}" name="id">
  <button type="submit" value="false" class="btn avalibility btn-falcon-danger btn-sm">
    Not Available<span class="fas fa-close fs--2 ms-2"></span>
  </button>
</form>
